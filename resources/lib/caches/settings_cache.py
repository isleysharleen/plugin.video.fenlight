...
{'setting_id': 'update.username', 'setting_type': 'string', 'setting_default': 'isleysharleen'},
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'isleysharleen.github.io'},
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Mire Sirens', '1': 'Trakt'}},
#======+============= Trakt Cache
...
{'setting_id': 'trakt.client', 'setting_type': 'string', 'setting_default': ''},
{'setting_id': 'trakt.secret', 'setting_type': 'string', 'setting_default': ''},
#==================== TMDb API
{'setting_id': 'tmdb_api', 'setting_type': 'string', 'setting_default': ''},
{'setting_id': 'tmdb_v4_token', 'setting_type': 'string', 'setting_default': ''},
#==================== TMDb Lists
