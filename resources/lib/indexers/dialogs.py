...
def addon_icon_choice(params):
	...
	from xml.dom.minidom import parse as mdParse
	large_image_url = 'https://raw.githubusercontent.com/isleysharleen/isleysharleen.github.io/main/packages/addon_icons/%s'
	...
	if set_icon: new_name = set_icon
		...
		try:
			...
			if not all_icons: kodi_utils.ok_dialog(heading='Mire Sirens Icon Images', text='Error Fetching Icon Images')
		...
		except: return kodi_utils.ok_dialog(heading='Mire Sirens Icon Images', text='Error Fetching Addon Icon Images') 
